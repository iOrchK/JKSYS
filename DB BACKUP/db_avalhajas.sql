...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2018 a las 17:01:54
...
INSERT INTO `estados_fisicos` (`id_estado_fisico`, `descripcion`, `estado`) VALUES
(1, 'Prenda', 1),
(2, 'Retaceria', 1),
(3, 'Lote', 0);
...
--
ALTER TABLE `valuaciones`
  MODIFY `id_valuacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
